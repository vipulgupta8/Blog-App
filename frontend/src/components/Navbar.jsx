...
function Navbar() {
  ...
  return (
    <>
      <div className="bg-[#eceef1] max-w-full relative flex justify-between items-center h-[70px] px-2 sm:px-[30px]  border-b drop-shadow-sm">
        <div className="flex gap-4 items-center relative">
          ...
          >
            ...
            <input
              type="text"
              className="bg-white focus:outline-none max-sm:w-[calc(100vw_-_70px)] rounded-full pl-12 p-2 "
              placeholder="Search"
